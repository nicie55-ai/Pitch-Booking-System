              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <select
                    ...
                    className="w-full bg-white border border-slate-300 rounded-lg py-2 px-3 text-xs font-bold text-slate-800 focus:border-blue-900 focus:outline-none"
                  >
                    <option value="5v5">5v5 Pitch (U7 - U9)</option>
                    <option value="7v7">7v7 Pitch (U10 - U11)</option>
                    <option value="9v9">9v9 Pitch (U12 - U13)</option>
                    <option value="11v11">11v11 Full Pitch (U14 - Adults)</option>
                  </select>
                </div>
              </div>
